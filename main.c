...
void mainmenu(void)
{
	...
	else if(choice==4)
	{
		...
		printf("*********Feeling Hungry ? Call or Walk-In FOODIE GOODIE KITCHEN right away and enjoy your snack at great discounts***************\n\n");
		exit(0);
	}
}
...
void viewrecord(void)
{
    ...
    printf("                 DEPARTMENT        ID        NAME OF THE EMPLOYEE        D.O.B        Y.O.J        PLACE\n\n");
...
void nonvegetarian(void)
{
	...
	printf("                                                  Non Veg. Menu\n");
	printf("                                    **********************************************\n");
     //	printf("1. Chicken sandwich meal pack            100-\n\n2. Gravy Chicken          120-\n\n3. Chicken Biryani        85-\n\n4. Beverages              35-\n\n5. Back To Main Menu\n\n\nEnter Your Choice");
	char n;
	FILE *nmenu;
